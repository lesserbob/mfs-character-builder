...
export async function seedSelectables(prisma: PrismaClient) {
  ...
  const selectableFeatures = [
    ...
    },
    {
      id: 48,
      name: 'Ambusher',
      description: 'When attacking a target from surprise, get +1d6 damage',
      selectableFeatureListId: 8,
    },
    {
      id: 49,
      name: 'Slippery',
      description: 'You can disengage as a minor action',
      selectableFeatureListId: 8,
    },
    {
      id: 50,
      name: 'Shadow Born',
      description: 'You can attempt stealth as a minor action',
      selectableFeatureListId: 8,
    },
    {
      id: 51,
      name: 'Resolute',
      description:
        'Gain +1 Boon to Resolve checks. Additionally, if you roll a natural 1 on an aptitude check, you can re-roll (once...)',
      selectableFeatureListId: 8,
    },
    {
      id: 52,
      name: 'Pack attacker',
      description:
        'If you are attacking an enemy and there is another ally engaged with that enemy, you get +1 Boon on attack rolls',
      selectableFeatureListId: 8,
    },
    {
      id: 53,
      name: 'Pofessional - might',
      description: '+1 boon to might apptitude checks',
      selectableFeatureListId: 9,
    },
    {
      id: 54,
      name: 'Pofessional - agility',
      description: '+1 boon to agility apptitude checks',
      selectableFeatureListId: 9,
    },
    {
      id: 55,
      name: 'Pofessional - intellect',
      description: '+1 boon to intellect apptitude checks',
      selectableFeatureListId: 9,
    },
    {
      id: 56,
      name: 'Pofessional - spirit',
      description: '+1 boon to spirit apptitude checks',
      selectableFeatureListId: 9,
    },
  ];
